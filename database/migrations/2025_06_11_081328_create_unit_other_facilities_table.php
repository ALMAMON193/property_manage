...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('unit_other_facilities', function (Blueprint $table) {
            ...
            $table->enum('individual_heating_type', ['electric', 'gas', 'fuel_oil', 'wood', 'heat_pump'])->nullable();
            $table->boolean('individual_heating_radiators')->default(false);
            $table->enum('individual_heating_radiators_type', ['electric', 'gas', 'cast_iron', 'steel', 'aluminum'])->nullable();
            ...
            $table->enum('individual_hot_water_type', ['electric', 'gas', 'solar', 'thermodynamic'])->nullable();
            ...
            $table->enum('vmc_type', ['single_flow', 'double_flow'])->nullable();
            ...
            $table->enum('television_connection_antenna_type', ['roof_antenna', 'cable', 'fiber'])->nullable();
