                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">All Retailers</h4>
...
@push('scripts')
        ...
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.retailer.index') }}",
                        type: "get",
    ...
    <script>
        ...
        function showStatusChangeAlert(event, checkboxElement, id) {
            event.preventDefault();
            let newStatus = checkboxElement.checked ? 'active' : 'in_active';

            Swal.fire({
                title: 'Are you sure?',
                text: 'You want to update the status to ' + (newStatus === 'active' ? 'Active' : 'Inactive') + '?',
                icon: 'info',
                showCancelButton: true,
        ...
        function updateStatus(id, newStatus) {
            var url = '{{ route('admin.retailer.status', ['id' => ':id']) }}';
            $.ajax({
                type: "POST",
                headers: {
